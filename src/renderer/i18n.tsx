...
export type TranslationKey =
  ...
  | `side.${"openConfigFolder" | "toggleCamouflageFloat" | "toggleWatchlistFloat" | "more" | "selectedSymbol" | "none" | "code" | "refresh" | "config" | "window" | "closeButton" | "minimizeToTray" | "close" | "theme" | "motto" | "toggleMottoFloat" | "mottoPlaceholder" | "font" | "size" | "color" | "unsavedMotto" | "saveMotto"}`
  | `settings.${"title" | "general" | "marketRefresh" | "mottoFloat" | "watchlistFloat" | "camouflageFloat" | "generalDescription" | "marketRefreshDescription" | "mottoDescription" | "watchlistDescription" | "camouflageDescription" | "windowCloseDescription" | "appearance" | "appearanceDescription" | "tradingRefreshInterval" | "tradingRefreshIntervalHint" | "watchlistProfile" | "profileName" | "saveProfile" | "resetDefault" | "profileNamePrompt" | "watchlistSymbols" | "watchlistColumns" | "watchlistStyle" | "searchWatchlistSymbols" | "selectedWatchlistSymbols" | "noWatchlistSymbols" | "layout" | "verticalLayout" | "horizontalLayout" | "fontFamily" | "fontSize" | "textColor" | "upColor" | "downColor" | "backgroundColor" | "backgroundOpacity" | "borderColor" | "showBorder" | "displayMode" | "camouflagePreview"}`
  | `float.${"addWatchlistSymbols" | "openWatchlistSettings"}`
